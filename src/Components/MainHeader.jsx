      ...
      <header>
        ...
        <div className="desktop-main-header hidden md:block border-b border-gray-300">
          <div className=" hidden py-4 md:flex container mx-auto responsive-padding justify-between gap-2 items-center">
            ...
            <div className="search-bar w-full text-center">
              <input
                className="w-3/4 border py-2 px-2 text-base text-gray-600 border-gray-300 rounded-md focus:ring-0 focus:outline-none"type="text" placeholder="Search here"
              />
            </div>
            <div className="shopping-cart">
              <ul className="flex justify-between gap-8 text-xl lg:text-2xl">
                <li className="relative hover:text-hover transition-all">
                  <Link to={"/wishlist"}>
                    <FaRegHeart />{" "}
                    <span className="absolute -bottom-3 -right-3 text-xs bg-primary rounded-full text-black font-semibold w-5 h-5 flex justify-center items-center">
                      0
                    </span>{" "}
                  </Link>
                </li>
        ...
        <div className="mobile-header border-b border-gray-300 py-2 md:hidden">
          <div className="container mx-auto responsive-padding flex justify-between items-center">
            <div className="menu-icon text-4xl" onClick={toggleSidebar}>
              <IoMenu />
            </div>
            <div className="logo">
              <Link to={"/"}>
                <img className="w-48 sm:w-48" src={logo} alt="Logo" />
              </Link>
            </div>
            <div className="shopping-cart">
              <ul className="flex justify-between gap-5 text-2xl sm:gap-6">
                <li className="relative hover:text-hover transition-all">
                  <Link to={"/wishlist"}>
                    <FaRegHeart />
                    <span className="absolute -bottom-2 -right-2 text-xs bg-primary rounded-full text-black font-semibold w-4 h-4 flex justify-center items-center">
                      0
                    </span>
                  </Link>
                </li>
          ...
          <nav>
            <ul className="flex flex-col text-gray-900 text-lg">
              <NavLink to={"/"} onClick={toggleSidebar}>
                <li className="text-base font-semibold px-2 py-2 border-b border-gray-300">
                  HOME
                </li>{" "}
              </NavLink>
